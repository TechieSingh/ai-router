...
$serverArgs = @('-m', ('"' + $manifest.modelPath + '"'), '--alias', 'local-coder', '--host', '127.0.0.1', '--port', "$Port", '--ctx-size', "$Context", '--parallel', '1', '--n-gpu-layers', '99', '--threads', '4', '--jinja', '--flash-attn', 'on', '--cache-type-k', 'q8_0', '--cache-type-v', 'q8_0')
